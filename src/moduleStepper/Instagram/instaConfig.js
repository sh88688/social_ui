...
import {InstagramIcon, ArrowBackIcon} from '../../theme/muiIcons';
            ...
            spacing={4}>
              <Grid item xs={12}>
                  ...
                  <Grid container
                    ...
                    <InstagramIcon style={{ color: "#770ee8",alignSelf: "center", marginRight: "5px"}} /> {` Configuration Details :`}
                    </Typography>
                    </Grid>
                    <Grid item xs={4}>
                    ...
                    <Grid item xs={4}>
                    <Typography variant="body2" color="textSecondary" component="h5">
                    {` Instagram ID : ${this.props.info.instagram_id}`}
                    </Typography>
                    </Grid>
                    <Grid item xs={4}>
                    <Typography variant="body2" color="textSecondary" component="h5">
